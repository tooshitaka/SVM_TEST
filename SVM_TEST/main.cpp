...
int main(int argc, char** argv)
{
	...
	int labels[100] = { -1, -1, -1, -1 };
	float trainingData[100][2] = { { 501, 10 },{ 10, 10 },{ 501, 501 },{ 10, 501 } };
	...
	for (int i = 4; i < 8; i++)
	{
		...
		for (int j = 0; j < 2; j++)
		{
			double rand_uni = rng.uniform(250, 252);
			double rand_gau = rng.gaussian(10.0);
			trainingData[i][j] = rand_uni + (int)rand_gau;
		}
	}
